...
public class Main {
    ...
    public static void main(String[] args) throws IOException, FunctionPointIndexOutOfBoundsException, InappropriateFunctionPointException, ClassNotFoundException {
        ...
        System.out.println("array3.toString(): " + array3 + "\n");

        System.out.println("linked1.toString(): " + linked1);
        System.out.println("linked2.toString(): " + linked2);
        System.out.println("linked3.toString(): " + linked3);
        ...
        System.out.println("Оригинальный массив hashCode():" + array1.hashCode());
        System.out.println("Клон массива hashCode():" + arrayClone.hashCode());
